...
class AnalysisHandler {
 ...
 public:
   ...
   */
  [[deprecated]] AnalysisHandler(const Configuration& /*conf*/);

  /**
   * @brief Constructor from an existing @c Analysis
   *
   * @param ana	The analysis to take ownership of
   */
  AnalysisHandler(std::unique_ptr<Analysis>&& ana);
