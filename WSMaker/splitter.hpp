...
class splitter {
 ...
 private:
  ...
  void writeOutFile(InputFile& inputFile, TString tagRegion, TString VpTbin, TString dist);
  ...
  void    findRegions(TDirectory* dir, std::vector<TString>& tagRegions, std::vector<TString>& vptBins,
                      std::vector<TString>& distributions, TString distToUse = "", TString anySample = "data");
