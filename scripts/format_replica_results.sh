...
formatting()
{
  ...
  do
    ...
    CUT="output/${WS}.${VERSION}_VHbbRun2_13TeV_${VERSION}_${NLEP}_125_Systs_use1tagFalse_use4pjetFalse_mBB/fccs"
    MVA="output/${WS}.${VERSION}_VHbbRun2_13TeV_${VERSION}_${NLEP}_125_Systs_use1tagFalse_use4pjetFalse_mva/fccs"
    CUTVAL=-999
    MVAVAL=-999
