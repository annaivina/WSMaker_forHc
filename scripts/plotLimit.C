...
void plotLimit(Int_t iv = 62, Int_t NTOT = 2, char* wsname, bool isExpected)
{
  ...
  //  if (NTOT == 1 ) { NPROBLEM =4; mass_problem[0] = 110; mass_problem[1] = 130; mass_problem[2] = 180;
  //  mass_problem[3] = 560; }
  ...
  for( int i = 0; i < Tot; i++ ) {
    ...
    cout << t_mass << "  " << observed << "  "
         << "  " << upperlimit << "  " << upperlimit_m2 << "  " << upperlimit_m1 << "  " << upperlimit_p1 << "  "
         << upperlimit_p2 << endl;
    ...
    fprintf(pFile4, "%12i  & %12.2f & %12.2f & %12.2f &  %12.2f & %12.2f \\\\ \n ", t_mass, upperlimit, upperlimit_p2,
            upperlimit_p1, upperlimit_m1, upperlimit_m2);

    likelihd_Observed_PCL[iline] = observed;

    if( observed < upperlimit_m1 )
      likelihd_Observed_PCL[iline] = upperlimit_m1;

    if( fabs(likelihd_m2[iline] - likelihd_m1[iline]) < 0.0001 )
      likelihd_m2[iline] = 0;
  ...
  for( Int_t i = 0; i < NPLOT; i++ )
    cout << FMSA[i] << "  " << likelihd_c[i] << "  " << likelihd_Observed[i] << endl;
  ...
  TGraphAsymmErrors* likelihd_limit_Observed_PCL =
      new TGraphAsymmErrors(NPLOT, FMSA, likelihd_Observed_PCL, zero, zero, zero, zero);
  ...
  TGraphAsymmErrors* likelihd_limit_Observed =
      new TGraphAsymmErrors(NPLOT, FMSA, likelihd_Observed, zero, zero, zero, zero);
  ...
  TGraphAsymmErrors* likelihd_limit_1sigma0j =
      new TGraphAsymmErrors(NPLOT, FMSA, likelihd_c, zero, zero, likelihd_m1_err, likelihd_p1_err);
  likelihd_limit_1sigma0j->SetFillColor(kGreen);

  TGraphAsymmErrors* likelihd_limit_2sigma0j =
      new TGraphAsymmErrors(NPLOT, FMSA, likelihd_c, zero, zero, likelihd_m2_err, likelihd_p2_err);
  ...
  TMultiGraph* likelihd_limit_0j = new TMultiGraph("", "; m_{H} [GeV]; 95% C.L. limit on #sigma/#sigma_{SM}");
  ...
  if( iv == 30 ) {
    if( NTOT == 0 )
      text2 = new TLatex(124, text2Y, "WH#rightarrow l#nub#bar{b}  (StatsOnly)");
    else if( NTOT == 1 )
      text2 = new TLatex(124, text2Y, "ZH#rightarrow l^{+}l^{-} b#bar{b}  (StatsOnly)");
    else if( NTOT == 2 )
      text2 = new TLatex(124, text2Y, "WH/ZH, H#rightarrow b#bar{b}  (StatsOnly)");
    else if( NTOT == 3 )
      text2 = new TLatex(124, text2Y, "ZH#rightarrow #nu#bar{#nu} b#bar{b}  (StatsOnly)");
    else if( NTOT == 4 )
      text2 = new TLatex(124, text2Y, "VH(b#bar{b}), combined  (StatsOnly)");
  } else if( iv == 43 ) {
    if( NTOT == 0 )
      text2 = new TLatex(125, text2Y, "WH, H#rightarrow bb,  (Overall)");
    else if( NTOT == 1 )
      text2 = new TLatex(125, text2Y, "ZH, H#rightarrow bb,  (Overall )");
    else if( NTOT == 2 )
      text2 = new TLatex(125, text2Y, "WH/ZH, H#rightarrow bb,  (Overall)");
    else if( NTOT == 3 )
      text2 = new TLatex(125, text2Y, "ZvvH, H#rightarrow bb,  (Overall)");
    else if( NTOT == 4 )
      text2 = new TLatex(125, text2Y, "VH#rightarrow bb,  (Overall)");
  } else if( iv == 62 ) {
    if( NTOT == 0 )
      text2 = new TLatex(125, text2Y, "WH#rightarrow l#nub#bar{b} ");
    else if( NTOT == 1 )
      text2 = new TLatex(125, text2Y, "ZH#rightarrow l^{+}l^{-} b#bar{b}");
    else if( NTOT == 2 )
      text2 = new TLatex(125, text2Y, "WH/ZH, H#rightarrow b#bar{b}");
    else if( NTOT == 3 )
      text2 = new TLatex(125, text2Y, "ZH#rightarrow #nu#bar{#nu} b#bar{b}");
    else if( NTOT == 4 )
      text2 = new TLatex(124.5, text2Y, "VH(b#bar{b}), combined");
  ...
  if( NTOT == 4 )
    text1 = new TLatex(124.5, text1Y, "#sqrt{s} = 7, 8 TeV,  #int Ldt = 4.6-4.7, 13 fb^{-1}");
